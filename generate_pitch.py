...
OUTPUT_PATH = Path("/workspaces/process-_mining_capability/Process_Mining_Tool_Pitch.pdf")
...
<div class="page">
  ...
  <div class="footer">
    <span>Case Management - Process Mining Tool</span>
    <span>2</span>
  </div>
</div>
...
<div class="page" style="display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center;">
  <div style="max-width: 500px;">
    ...
    <p style="font-size: 12px; color: #aaa; margin-top: 40px;">
      Case Management - Process Mining Tool &bull; Confidential &bull; April 2026
    </p>
  </div>
</div>
